...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            label3.Text = "Drag && Drop flashable ZIP here";
        ...
        private void panel1_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (String fzip in (String[])e.Data.GetData(DataFormats.FileDrop))
                label5.Text = (System.IO.Path.GetFileName(fzip)) + " loaded";
            ...
            if (textBox2.Text == ".zip")
            {
            }
            else if (textBox2.Text == ".ZIP")
            {
            }
            else
            {
                MessageBox.Show("Sorry, no ZIP-File!", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox2.Text == ".zip")
            {
...

                {
                    if (sw.BaseStream.CanWrite)
                        sw.WriteLine("adb sideload " + quote + textBox1.Text + quote);
                }
                sw.Close();
                p.WaitForExit();
                p.Close();
            ...
            {
                MessageBox.Show("Sorry, no ZIP-File loaded!", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.Title = "Choose flashable ZIP..";
